...
- [ ] **INFRA-01**: Vercel + Supabase projects provisioned; app deploys on merge to main with PR preview deployments and CI tests
...
- [ ] **INFRA-08**: Sentry (client + server) and Axiom log aggregation capture errors and structured logs
