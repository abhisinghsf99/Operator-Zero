...
Last activity: 2026-06-18 - Completed quick task 260618-nja: land new users on Workflows after onboarding. Both onboarding redirects (completeOnboarding + completed-onboarding guard) now point to /app/workflows instead of /app/chat (canonical default landing per D-16). Login + demo/sandbox already landed there. ONBOARD-08 test + doc comments updated; 15/15 onboarding-progress tests green.
