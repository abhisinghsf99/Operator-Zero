 ...
 * Tool registry — aggregates all 11 read + 14 write + 5 meta tools.
 *
 * Exports:
 ...
 *   WRITE_TOOL_NAMES              — array of 14 write tool names
...
/** The exact 14 write tool names (from TECH-SPEC.md §tool-catalog) */
